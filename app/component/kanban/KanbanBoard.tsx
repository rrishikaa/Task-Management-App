...
export default function KanbanBoard(): ReactNode {
    ...
    const getFilteredTasks = (tasks: Tasks): Tasks => {
        ...
        return {
            ...
            review: tasks.review.filter(task=>task.priority===priorityFilter),
  ...
  setModalState({ isOpen: false, mode: 'create' });
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-4 md:py-8">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 p-2 ml-4 bg-gray-100 max-w-full">Task Management Dashboard</h1>
